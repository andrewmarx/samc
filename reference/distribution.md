...
Calculate the probability of being at a transient state at a specific
time.
...
- **distribution(samc, time)**
  ...
  being at transient state \\\mathit{j}\\ after \\\mathit{t}\\ time
...
- **distribution(samc, origin, time)**
  ...
  probability of being at transient state \\\mathit{j}\\ after
...
- **distribution(samc, origin, dest, time)**
  ...
  The result is a numeric value that is the probability of being at a
  transient state \\\mathit{j}\\ after \\\mathit{t}\\ time steps if
...
- **distribution(samc, init, time)**
  ...
  The result is a vector \\\mathbf{v}\\ where \\\mathbf{v}\_j\\ is the
  probability of being at transient state \\\mathit{i}\\ after
  \\\mathit{t}\\ time steps given an initial state \\\psi\\.
