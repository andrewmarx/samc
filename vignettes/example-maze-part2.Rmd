...
The next part of this example series we will take the maze with only a single solution and modify it with a "secret" shortcut. Wrapping up this example, Part 3 will then take all of the changes introduced in the series and combine them into a single final example.
